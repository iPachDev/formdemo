    ...
    >
        <div className="w-full h-screen">
            <div className="h-screen flex items-center justify-center">
                <div className="bg-black w-3/4 rounded-md p-6 drop-shadow-md bg-opacity-30 backdrop-blur-md shadow-lg">
                    <div
                        className="text-1xl font-light text-center text-white"
